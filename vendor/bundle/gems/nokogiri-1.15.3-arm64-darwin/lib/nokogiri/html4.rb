...
module Nokogiri
  class << self
    # :call-seq:
    #   HTML4(input, url = nil, encoding = nil, options = XML::ParseOptions::DEFAULT_HTML, &block) → Nokogiri::HTML::Document
    #
    # Parse HTML. Convenience method for Nokogiri::HTML::Document.parse
    def HTML4(input, url = nil, encoding = nil, options = XML::ParseOptions::DEFAULT_HTML, &block)
      Nokogiri::HTML::Document.parse(input, url, encoding, options, &block)
    end
  end

  # Since v1.12.0
  #
  # 💡 Before v1.12.0, Nokogiri::HTML did not exist, and Nokogiri::HTML was the module/namespace
  # for parsing HTML.
  module HTML4
    class << self
      ###
